...
- Yo diria que los protocolos, si es que pasa todos los ejemplos como queremos, son casi igual de expresivos que pre y post condiciones para modelar secuencias de llamados, siempre y cuando admitamos hacer más restrictivo el código que se puede escribir. Es decir, "sacarle jugo" al poder de Jatyc.
